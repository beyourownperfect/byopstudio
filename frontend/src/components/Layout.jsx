  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="px-3 sm:px-5 py-2.5 flex items-center justify-between gap-2 sm:gap-4">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="leading-tight min-w-0">
              ...
              <div className="text-[9px] tracking-[0.18em] uppercase text-[hsl(var(--fg-subtle))] truncate">Study OS · v2.2</div>
            </div>
          </div>
      ...
      <main className="flex-1 px-3 sm:px-5 py-4 sm:py-5 max-w-[1400px] w-full mx-auto">
        {cmdHint && (
          <div className="mb-4 px-3 py-1.5 flex items-center justify-between gap-3 text-[11px] text-[hsl(var(--fg-subtle))] bg-[hsl(var(--bg-elev))]/40 rounded border border-border/40">
            <span>
              Press <kbd className="px-1 py-px bg-[hsl(var(--bg-elev-2))] border border-border/50 rounded text-[10px] mono text-[hsl(var(--fg-muted))]">{isMac ? "⌘K" : "Ctrl+K"}</kbd> to search, navigate, or jump anywhere
            </span>
            <button onClick={dismissCmdHint} className="btn-ghost p-0.5 text-[hsl(var(--fg-subtle))] hover:text-[hsl(var(--fg))]" title="Dismiss"><X className="w-3 h-3" /></button>
          </div>
        )}
        <Outlet />
      </main>
