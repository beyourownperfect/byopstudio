...
SAMPLE_QUESTIONS = [
    ...
    },
    {
        ...
        "difficulty": "Medium",
        "question_type": "NAT",
        "statement": "Consider the C code:\n```c\nint arr[] = {10, 20, 30, 40, 50};\nint *p = arr;\nprintf(\"%d\", *(p + 2));\n```\nWhat is the output?",
        "correct_answer": "30",
        "explanation": "$p$ points to `arr[0]`. $p + 2$ points to `arr[2]` which is $30$.",
        "gateoverflow_url": "https://gateoverflow.in/",
    },
    {
        "subject": "CD",
        ...
        "difficulty": "Medium",
        "question_type": "MCQ",
        "statement": "Which of the following grammars is $LL(1)$?",
        "options": [
            "$S \\to aS \\mid a$",
            "$S \\to aSb \\mid \\epsilon$",
            "$S \\to Sa \\mid b$",
        ...
        "correct_answer": "B",
        "explanation": "Only $S \\to aSb \\mid \\epsilon$ is LL(1) — no left recursion, no ambiguity, and FIRST/FOLLOW sets are disjoint.",
        "gateoverflow_url": "https://gateoverflow.in/",
    },
    {
        "subject": "DL",
        ...
        "difficulty": "Easy",
        "question_type": "MCQ",
        "statement": "The minimized Boolean expression for $F(A, B, C) = \\Sigma m(0, 1, 3, 5, 7)$ is:",
        "options": [
            "$A'B' + C$",
            "$A'C' + BC$",
            "$A'C' + AC$",
        ...
        "correct_answer": "A",
        "explanation": "Using a 3-variable K-map: the minterms group to $A'B' + C$.",
        "gateoverflow_url": "https://gateoverflow.in/",
    },
    {
        "subject": "EM",
        ...
        "difficulty": "Medium",
        "question_type": "MCQ",
        "statement": "If $A$ is a $3 \\times 3$ matrix with eigenvalues $2, 3, 5$, then $\\det(A^{-1})$ is:",
        "options": [
            "$\\frac{1}{30}$",
            "$\\frac{1}{10}$",
            "$30$",
        ...
        "correct_answer": "A",
        "explanation": "$\\det(A) = 2 \\times 3 \\times 5 = 30$. $\\det(A^{-1}) = \\frac{1}{\\det(A)} = \\frac{1}{30}$.",
        "gateoverflow_url": "https://gateoverflow.in/",
    },
]
